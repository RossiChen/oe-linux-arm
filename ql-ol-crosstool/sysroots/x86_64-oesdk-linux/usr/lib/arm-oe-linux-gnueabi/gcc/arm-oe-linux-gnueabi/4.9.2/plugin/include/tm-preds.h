/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/gale/workspace0/MDM9x07/OpenLinux/MCU_R02_update07/apps_proc/oe-core/build/tmp-glibc/work-shared/gcc-4.9.2-r0/gcc-4.9.2/gcc/config/arm/arm.md'.  */
