...
typedef void (*ql_tts_cb_type)(ql_tts_client_event_e_type evt, char *str);
...
int   QL_TTS_client_play(ql_tts_data_mode_e_type play_mode, ql_tts_data_mode_e_type data_mode, char *text, int text_len);
int   QL_TTS_client_stop(void);

void  QL_TTS_client_volume_set(int v);
int   QL_TTS_client_volume_get(void);
void  QL_TTS_client_speed_set(int v);
