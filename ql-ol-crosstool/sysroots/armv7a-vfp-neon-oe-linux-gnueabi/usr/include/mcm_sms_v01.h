...
typedef enum {
  ...
  MCM_SMS_MSG_FORMAT_TEXT_ASCII_V01 = 1, /**<  Message format ASCII text. */
  MCM_SMS_MSG_FORMAT_TEXT_UTF8_V01 = 2, /**<  Message format UTF8 text. */
  MCM_SMS_MSG_FORMAT_BINARY_STREAM_V01 = 3, /**<  Message format binary stream. */
